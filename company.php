...
if (isset($obj->search_text)) {
    ...
    $stmt->bind_param("sssssssssssss", $company_name, $mobile_number, $gst_no, $address, $city, $state, $bill_prefix, $fssai_code, $bank_name, $ifsc_code, $acc_no, $upi_no, $company_id);
